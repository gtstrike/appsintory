...
public class PekerjaanController {
    ...
    public void simpan(
            javax.swing.JTextField kodePekerjaanTextField,
        ...
        if (!kodePekerjaanTextField.getText().equals("")) {
            ...
            pekerjaan.setKodePekerjaan(
                    kodePekerjaanTextField.getText()
            );

            pekerjaan.setNamaPekerjaan(
                    namaPekerjaanTextField.getText()
            );

            pekerjaan.setJumlahTugas(
                    Integer.parseInt(
                            jumlahTugasComboBox
                                    .getSelectedItem()
                                    .toString()
            ...
            JOptionPane.showMessageDialog(
                    null,
                    "Kode pekerjaan tidak boleh kosong",
                    "Kesalahan",
                    JOptionPane.ERROR_MESSAGE
            );
        }
    ...
    public void cari(
        ...
        if (!kodePekerjaanTextField.getText().equals("")) {
            ...
            if (pekerjaan.baca(
                ...
                FormUtama.formPekerjaan.setJumlahTugas(
                        pekerjaan.getJumlahTugas()
                );
